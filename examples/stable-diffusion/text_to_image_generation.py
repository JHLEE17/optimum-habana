...
def generate_images(
    ...
    **kwargs
    ...
    scheduler_obj = GaudiFlowMatchEulerDiscreteScheduler.from_pretrained(
        model_name_or_path, subfolder="scheduler", timestep_spacing="linspace"
    )
    kwargs_pipe = {
    ...
    if bf16:
        kwargs_pipe["torch_dtype"] = torch.bfloat16
    pipeline = GaudiFluxPipeline.from_pretrained(model_name_or_path, **kwargs_pipe)
